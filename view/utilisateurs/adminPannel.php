<a class="button" href="index.php?controller=utilisateurs&action=readAll">Utilisateurs<a>
<a class="button" href="index.php?controller=produits&action=readAll">Produits<a>
